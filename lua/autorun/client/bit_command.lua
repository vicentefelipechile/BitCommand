...
BIT.func = {
    ["arshift"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.arshift(x,y) end,
    ["band"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.band(x,y) end,
    ...
    ["bxor"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.bxor(x,y) end,
    ["lshift"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.lshift(x,y) end,
    ["rol"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.rol(x,y) end,
    ["ror"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.ror(x,y) end,
    ["rshift"] = function(n) local x,y=tN(n[1]), tN(n[2]) if not ( iN(x) and iN(y) ) then return "Your inputs values are not a Number!" end return bit.rshift(x,y) end,
